...
describe "group_stats/new" do
  before(:each) do
    assign(:group_stat, stub_model(GroupStat,
      :group_id => 1,
      :matches_played => 1,
      :wins => 1,
      :draws => 1,
  ...
  it "renders new group_stat form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => group_stats_path, :method => "post" do
